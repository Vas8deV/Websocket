...
$inputFolder = "D:\websock_FATFS\fs_deflate"  # Replace with the actual folder path containing files
$binsrcPath = "D:\html\binsrc\binsrc.exe"   # Replace with the actual path to binsrc.exe
$outputFolder = "D:\websock_FATFS\fs_deflate_array" # Replace with the path where you want the output files
